...
SECRET_KEY = "django-insecure-u@$7dskd^sa_ve%9^n$%q(zp&5xnk^(4ufwj@(e2e89#(!7hd*"
...
DATABASES = {
    ...
    # }
      "default": {
        ...
        "NAME": "railway",
        "USER":"postgres",
        "PASSWORD":"IXlgAiPXrDRGONJgngcIEsBiSzjvMnKJ",
        "PORT": "14979",
...
# ??? LOGIN SETTINGS
LOGIN_REDIRECT_URL = "authentication:check_who_loggedin"
